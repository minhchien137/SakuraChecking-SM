...
namespace ScanCheckSakura.Services
{
    ...
    public class FqcOdooService : IFqcOdooService
    {
        ...
        // ── PostCommentBySerialWithLogAsync ───────────────────────────────────────
        // Hàm mới — logic giống PostCommentBySerialAsync,
        // chỉ khác: body comment được ghép thêm TestLog (dạng bảng HTML).
        public async Task PostCommentBySerialWithLogAsync(
            string serial,
            string commentBody,
            JsonElement testLog)
        {
